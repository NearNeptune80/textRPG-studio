...
export const PREMADE_WIDGETS: CustomWidgetDefinition[] = [
  ...
  {
    id: "widget_lt_time_bar",
    name: "Calendar Time & Date Bar",
    description: "Compact calendar date and game time header bar",
    isPremade: true,
    layoutDirection: "HORIZONTAL",
    gap: 4,
    padding: 4,
    elements: [{ id: "e_lt_time_only", type: "TIME_DATE_BANNER" }],
  },
  {
    id: "widget_lt_radar_map",
    name: "5x5 Radar Navigation Map",
    description: "Centered 5x5 overworld map grid with 3-tier fog of war discovery",
    isPremade: true,
    layoutDirection: "VERTICAL",
    gap: 4,
    padding: 6,
    elements: [{ id: "e_lt_radar_only", type: "MINIMAP_DPAD_RADAR" }],
  },
  {
    id: "widget_lt_options_toolbar",
    name: "Navigation Options Toolbar (5 Buttons)",
    description: "Bottom utility buttons: Settings, Phone menu, Wardrobe, Inventory, Character View",
    isPremade: true,
    layoutDirection: "HORIZONTAL",
    gap: 4,
    padding: 4,
    elements: [{ id: "e_lt_toolbar_only", type: "BOTTOM_TOOLSTRIP" }],
  },
  {
